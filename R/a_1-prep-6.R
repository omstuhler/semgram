...
###############################################################################################
##### Rule: aux dependent of nsubj act's conj verb with prep
##### Example: "ENTITY came and might play against him." (might)

a_1_prep_6 = function(tokens, entities, verb_pos, agent_patient_pos, extract, verb_prep_dist){
  ...
  fuck = annotate_tqueries(tokens, "query", rule, overwrite = T, copy = F)
