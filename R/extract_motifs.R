...
#' entities defaults to "*" in which case any token is treated as a potential entity.
...
#' @param parse_multi_token_entities Should multi-token entities (e.g. "Harry Potter') be considered. Defaults to TRUE.
