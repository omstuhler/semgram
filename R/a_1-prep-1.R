...
###############################################################################################
##### Rule: nsubj act with prep
##### Example: "ENTITY played against Joe." (play_against)
...
a_1_prep_1 = function(tokens, entities, verb_pos, agent_patient_pos, extract, verb_prep_dist){
